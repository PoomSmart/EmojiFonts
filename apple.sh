...
mv apple/${OUT_FONT_NAME}_00.ttf apple/${OUT_FONT_NAME}.ttf

python3 otf2otc.py apple/${OUT_FONT_NAME}.ttf apple/${OUT_FONT_NAME}_01.ttf -o apple/$OUT_FONT_NAME.ttc
